...
(6, 'Arthur_Devian', 905.098, -1486.08, 13.5517, 90, 0, 31, 'Paturr', '52', 'america', 1, 23, 100, 89.14, 91.31, '082192508440', 100, 1734369150, '', '', '', 0, 0, 1488, 0, 0, 0, 0, 0, 0);

-- --------------------------------------------------------

--
-- Struktur dari tabel `dealer_vehicle`
--
...
--
-- Dumping data untuk tabel `dealer_vehicle`
--
...
(12, 'Paturr', '$2y$12$giiP1raTrliOeZtN5Hzy0uXDXK/dlJ90QtWIRSidbxmPaBeSoEQ1K');
...
(48, 461, 1077.83, -1374.47, 18.67, 163.53, -1, -1, 0, 0, 'NotCustom', 4, 6, 1, 100, '', 0),
(49, 461, 1088.32, -1391.71, 13.58, 216.05, -1, -1, 0, 0, 'NotCustom', 4, 6, 1, 100, '', 0);

-- --------------------------------------------------------

--
-- Struktur dari tabel `weapon_players`
--
...
--
-- Dumping data untuk tabel `weapon_players`
--
...
--
-- Indeks untuk tabel `dealer_vehicle`
--
...
--
-- Indeks untuk tabel `weapon_players`
--
...
--
-- AUTO_INCREMENT untuk tabel `dealer_vehicle`
--
ALTER TABLE `dealer_vehicle`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT untuk tabel `doors`
--
ALTER TABLE `doors`
...
--
-- AUTO_INCREMENT untuk tabel `weapon_players`
--
ALTER TABLE `weapon_players`
